...
function preloadResources(canvas, callback) {
  ...
  let rl = new ResourceLoader(printProgressBar, callback);
	/*
  ...
  let percent = Math.floor((rl.resourcesLoaded * 100) / rl.resources.length);
		/*
...
// console.log(e.touches[0].pageX);
  //  e.preventDefault();
  for (let i = 0; i < e.touches.length; i++) { // console.log(e.touches[i].pageX+" ;"+e.touches[i].pageY);
      touchHandler(e.touches[i]);
    }
  e.preventDefault();
